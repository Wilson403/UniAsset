...
namespace UniAsset
{
    ...
    public class FileSystem
    {
        ...
        public static void DelectAllFilesInDir (string srcPath , params string [] white)
        {
        ...
        /// <param name="extFileNames">要过滤的文件名称</param>
        public static void Copy (string source , string target , bool overwrite , string [] extFilters = null , SearchOption copyOptions = SearchOption.AllDirectories)
        {
            ...
            {
                var subFiles = Directory.GetFiles (source , "*" , copyOptions);
